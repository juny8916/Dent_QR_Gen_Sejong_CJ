...
def _render_chatbot_widget(extra_json: str, tel_href: str, map_href: str) -> str:
    ...
    return (
        ...
        "<button type=\"button\" data-quick=\"director\">대표원장</button>"
        "</div>"
        ...
        "addMessage('안내 가능한 항목: 진료시간/주차/예약/오시는 길/대표원장', 'bot');"
        ...
        "if(text.indexOf('대표원장')!==-1||text.indexOf('원장')!==-1||text.indexOf('의사')!==-1){if(quick.director){respond(quick.director);return;}}"
        ...
        "var key=btn.getAttribute('data-quick');"
        "var quick=extra.quick_actions||{};"
        "var map={hours:quick.hours,parking:quick.parking,reservation:quick.reservation,directions:quick.directions,director:quick.director};"
